...
if __name__ == '__main__':
    ...
    ## set the parameters
    coef_penalizers = [0.01, 0.03, 0.05, 0.07, 0.09, 0.11, 0.13, 0.15, 0.17,
                       0.19, 0.21, 0.23, 0.25, 0.27, 0.29, 0.32, 0.35, 0.38,
                       0.4, 0.42, 0.45, 0.48, 0.5, 0.53, 0.56, 0.6, 0.63,
                       0.66, 0.7, 0.73, 0.76, 0.8, 0.83, 0.86, 0.9]
    ...
    for pca_flag in pca_flags:
        for dataset_idx, dataset_name in enumerate(dataset_names):
            ...
            for row, coef_penalizer in enumerate(coef_penalizers):
                ...
                concordances[coef_penalizer] = avg_concordance
                ipecs[coef_penalizer] = avg_ipec
